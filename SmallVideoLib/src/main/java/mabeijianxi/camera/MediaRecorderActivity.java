...
public class MediaRecorderActivity extends Activity implements
    ...
    private static MediaRecorderListener mListener;

    private boolean GO_HOME;
    /**
     * @param
     */
    public static void goSmallVideoRecorder(Activity context, MediaRecorderListener mediaRecorderListener, MediaRecorderConfig mediaRecorderConfig) {
...
//                intent.putExtra(MediaRecorderActivity.VIDEO_URI, mMediaObject.getOutputTempTranscodingVideoPath());
                mediaRecorder.setVideoUri(mMediaObject.getOutputTempTranscodingVideoPath());
            }else {
//                intent.putExtra(MediaRecorderActivity.VIDEO_URI, mMediaObject.getOutputTempVideoPath());
                mediaRecorder.setVideoUri(mMediaObject.getOutputTempVideoPath());
            }
//            intent.putExtra(MediaRecorderActivity.VIDEO_SCREENSHOT, mMediaObject.getOutputVideoThumbPath());
            mediaRecorder.setVIDEOSCREENSHOT(mMediaObject.getOutputVideoThumbPath());
//            intent.putExtra("go_home",GO_HOME);
//            startActivity(intent);
            mListener.onEncodeComplete(mediaRecorder);
        } catch (Exception e) {
